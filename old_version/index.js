...
async function main_2_sell() {
    while (!stopCommand_2) {
        ...
        const filePath = 'output.txt';
        const nameToSearch = itemSellCollector_2; // Oggetto da cercare
        ...
        await sleep(timeSellCollector_2); // Ritardo tra le esecuzioni
    };
};

// BUY

async function altMain_2_buy() {
    while (!stopCommand_2) {
        buyProgramStatus_2 = 'active';
        ...
        const filePath = 'output.txt';
        const nameToSearch = itemBuyCollector_2; // Oggetto da cercare
        ...
        await sleep(timeBuyCollector_2); // Ritardo tra le esecuzioni
    };
};
...
async function main_3_sell() {
    while (!stopCommand_3) {
        ...
        const filePath = 'output.txt';
        const nameToSearch = itemSellCollector_3; // Oggetto da cercare
        ...
        await sleep(timeSellCollector_3); // Ritardo tra le esecuzioni
    };
};

// BUY

async function altMain_3_buy() {
    while (!stopCommand_3) {
        buyProgramStatus_3 = 'active';
        ...
        const filePath = 'output.txt';
        const nameToSearch = itemBuyCollector_3; // Oggetto da cercare
        ...
        await sleep(timeBuyCollector_3); // Ritardo tra le esecuzioni
    };
};